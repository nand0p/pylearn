...
html += '<title>art.hex7.com</title>'
html += '</head><body><h1>art.hex7.com</h1>'
...
for image in s3_list:
  ...
  del image_keys[-1]
  html += '<img src=http://art.hex7.com.s3-website-us-east-1.amazonaws.com/' + image + '><br>' + ' '.join(image_keys) + '<p>'
